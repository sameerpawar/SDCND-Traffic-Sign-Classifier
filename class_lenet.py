...
# - unlike origiinal LeNet, LeNet++ accepts color 32*32 images and any number of classes (< 84)
#*******************************************************************************#
    ...
    save_trained_weights = None, verbose = False):
        ...
        with tf.Session() as sess:      
            ...
            for i in range(epochs):    
                ...
                if verbose:      
                    print("training   accuracy = {}".format(training_results['accuracy']))
                    print("validation accuracy = {}".format(validation_results['accuracy']))
                    print("training   loss = {}".format(training_results['loss']))
                    print("validation loss = {}".format(validation_results['loss']))

...
{\color{incolor}In [{\color{incolor}1}]:} \PY{k+kn}{import} \PY{n+nn}{pickle}
        ...
        \PY{n}{MODIFIED\PYZus{}LENET} \PY{o}{=} \PY{k+kc}{True}
        \PY{n}{PREPROCESSING} \PY{o}{=} \PY{k+kc}{True}
        \PY{n}{NORM\PYZus{}GRAY} \PY{o}{=} \PY{k+kc}{True}
        \PY{n}{DISPLAYSAMPLES} \PY{o}{=} \PY{k+kc}{True}
        \PY{n}{TRAIN\PYZus{}MODEL} \PY{o}{=} \PY{k+kc}{True}
        \PY{n}{EVALUATE} \PY{o}{=} \PY{k+kc}{True}
        \PY{n}{PRINT\PYZus{}DATASET\PYZus{}STAT} \PY{o}{=} \PY{k+kc}{True}
        \PY{n}{DATA\PYZus{}VISUALIZATION} \PY{o}{=} \PY{k+kc}{True}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}3}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Replace each question mark with the appropriate value. }
        ...
        \PY{n}{n\PYZus{}valid} \PY{o}{=} \PY{n}{X\PYZus{}valid}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
        ...
        \PY{n}{image\PYZus{}shape} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{n}{X\PYZus{}train}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{n}{X\PYZus{}train}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}\PY{p}{]}\PY{p}{)}
        ...
        \PY{k}{if} \PY{n}{PRINT\PYZus{}DATASET\PYZus{}STAT}\PY{p}{:}
...
{\color{incolor}In [{\color{incolor}4}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Data exploration visualization code goes here.}
        ...
        \PY{k}{if} \PY{n}{DATA\PYZus{}VISUALIZATION}\PY{p}{:}
            \PY{c+c1}{\PYZsh{} Histogram of train}
            \PY{n}{hist\PYZus{}y\PYZus{}train} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{bincount}\PY{p}{(}\PY{n}{y\PYZus{}train}\PY{p}{)}
            \PY{n}{hist\PYZus{}y\PYZus{}valid} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{bincount}\PY{p}{(}\PY{n}{y\PYZus{}valid}\PY{p}{)}
        
            \PY{n}{nhist\PYZus{}y\PYZus{}train} \PY{o}{=} \PY{n}{hist\PYZus{}y\PYZus{}train}\PY{o}{*}\PY{l+m+mi}{100}\PY{o}{/}\PY{n}{n\PYZus{}train}
            \PY{n}{nhist\PYZus{}y\PYZus{}valid} \PY{o}{=} \PY{n}{hist\PYZus{}y\PYZus{}valid}\PY{o}{*}\PY{l+m+mi}{100}\PY{o}{/}\PY{n}{n\PYZus{}valid}
        
            \PY{n}{y\PYZus{}pos} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{n}{N\PYZus{}CLASSES}\PY{p}{)}
            \PY{n}{fig}\PY{p}{,} \PY{n}{ax} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{subplots}\PY{p}{(}\PY{p}{)}
            \PY{n}{ax}\PY{o}{.}\PY{n}{bar}\PY{p}{(}\PY{n}{y\PYZus{}pos}\PY{p}{,} \PY{n}{nhist\PYZus{}y\PYZus{}train}\PY{p}{,} \PY{l+m+mf}{0.35}\PY{p}{,} \PY{n}{align}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{center}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{alpha}\PY{o}{=}\PY{l+m+mf}{0.5}\PY{p}{,} \PY{n}{color} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{b}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{label} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{train}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
            \PY{c+c1}{\PYZsh{}ax.bar(y\PYZus{}pos, nhist\PYZus{}y\PYZus{}valid, 0.8, align=\PYZsq{}center\PYZsq{}, alpha=0.5, color = \PYZsq{}g\PYZsq{}, label = \PYZsq{}valid\PYZsq{})}
            \PY{n}{ax}\PY{o}{.}\PY{n}{set\PYZus{}ylabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Percentage of total samples}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
            \PY{n}{legend} \PY{o}{=} \PY{n}{ax}\PY{o}{.}\PY{n}{legend}\PY{p}{(}\PY{n}{loc}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{upper center}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{shadow}\PY{o}{=}\PY{k+kc}{True}\PY{p}{,} \PY{n}{fontsize}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{x\PYZhy{}large}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
            \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)} 
        
            \PY{n}{fig}\PY{p}{,} \PY{n}{ax} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{subplots}\PY{p}{(}\PY{p}{)}
            \PY{c+c1}{\PYZsh{}ax.bar(y\PYZus{}pos, nhist\PYZus{}y\PYZus{}train, 0.35, align=\PYZsq{}center\PYZsq{}, alpha=0.5, color = \PYZsq{}b\PYZsq{}, label = \PYZsq{}train\PYZsq{})}
            \PY{n}{ax}\PY{o}{.}\PY{n}{bar}\PY{p}{(}\PY{n}{y\PYZus{}pos}\PY{p}{,} \PY{n}{nhist\PYZus{}y\PYZus{}valid}\PY{p}{,} \PY{l+m+mf}{0.8}\PY{p}{,} \PY{n}{align}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{center}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{alpha}\PY{o}{=}\PY{l+m+mf}{0.5}\PY{p}{,} \PY{n}{color} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{g}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{label} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{valid}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
            \PY{n}{ax}\PY{o}{.}\PY{n}{set\PYZus{}ylabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Percentage of total samples}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
            \PY{n}{legend} \PY{o}{=} \PY{n}{ax}\PY{o}{.}\PY{n}{legend}\PY{p}{(}\PY{n}{loc}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{upper center}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{shadow}\PY{o}{=}\PY{k+kc}{True}\PY{p}{,} \PY{n}{fontsize}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{x\PYZhy{}large}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
            \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)} 
           
            \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Distribution of different classes in training is }\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{p}{(}\PY{n}{hist\PYZus{}y\PYZus{}train}\PY{p}{)}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor}5}]:} \PY{k+kn}{import} \PY{n+nn}{cv2}
        \PY{c+c1}{\PYZsh{} Display random images of a particular label from the data}
        \PY{k}{def} \PY{n+nf}{display\PYZus{}sign}\PY{p}{(}\PY{n}{data\PYZus{}set}\PY{p}{,} \PY{n}{y\PYZus{}label}\PY{p}{,} \PY{n}{y}\PY{p}{,} \PY{n}{num\PYZus{}img}\PY{p}{)}\PY{p}{:}    
            \PY{n}{data\PYZus{}set} \PY{o}{=} \PY{n}{data\PYZus{}set}\PY{p}{[}\PY{n}{np}\PY{o}{.}\PY{n}{where}\PY{p}{(} \PY{n}{y\PYZus{}label} \PY{o}{==} \PY{n}{y} \PY{p}{)}\PY{p}{]}
            \PY{n}{nSamples} \PY{o}{=} \PY{n}{data\PYZus{}set}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
            \PY{n}{indices}  \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{unique}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{random}\PY{o}{.}\PY{n}{randint}\PY{p}{(}\PY{n}{nSamples}\PY{p}{,} \PY{n}{size} \PY{o}{=} \PY{l+m+mi}{4}\PY{o}{*}\PY{n}{num\PYZus{}img}\PY{p}{)}\PY{p}{)}
            \PY{n}{indices}  \PY{o}{=} \PY{n}{indices}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{:}\PY{n}{num\PYZus{}img}\PY{p}{]}
            \PY{k}{for} \PY{n}{idx} \PY{o+ow}{in} \PY{n}{indices}\PY{p}{:}
                \PY{n}{img} \PY{o}{=} \PY{n}{data\PYZus{}set}\PY{p}{[}\PY{n}{idx}\PY{p}{]}
                \PY{c+c1}{\PYZsh{}img = cv2.cvtColor( img, cv2.COLOR\PYZus{}RGB2YUV)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:} \PY{k}{if} \PY{n}{DISPLAYSAMPLES}\PY{p}{:}
            \PY{n}{label} \PY{o}{=} \PY{l+m+mi}{23}
            \PY{n}{num\PYZus{}samples} \PY{o}{=} \PY{l+m+mi}{5}
            \PY{n}{display\PYZus{}sign}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{,}\PY{n}{y\PYZus{}train}\PY{p}{,} \PY{n}{label}\PY{p}{,}\PY{n}{num\PYZus{}samples}\PY{p}{)}
\end{Verbatim}
...
the first step of your project.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Preprocess the data here. It is required to normalize the data. Other preprocessing steps could include }
        \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} converting to grayscale, etc.}
        \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Feel free to use as many code cells as needed.}
        \PY{c+c1}{\PYZsh{} Display random images of a particular label from the data}
        \PY{k+kn}{import} \PY{n+nn}{cv2}
        \PY{k}{def} \PY{n+nf}{normalize\PYZus{}dataset}\PY{p}{(}\PY{n}{data\PYZus{}set}\PY{p}{)}\PY{p}{:}    
            \PY{n}{n\PYZus{}samples}  \PY{o}{=} \PY{n}{data\PYZus{}set}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
            \PY{n}{n\PYZus{}channels} \PY{o}{=} \PY{n}{data\PYZus{}set}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{3}\PY{p}{]}
            \PY{n}{norm\PYZus{}data\PYZus{}set} \PY{o}{=} \PY{p}{[}\PY{p}{]}
            \PY{k}{for} \PY{n}{s} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{n\PYZus{}samples}\PY{p}{)}\PY{p}{:}
                \PY{n}{img} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{float32}\PY{p}{(}\PY{n}{data\PYZus{}set}\PY{p}{[}\PY{n}{s}\PY{p}{]}\PY{p}{)}
                \PY{k}{for} \PY{n}{ch} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{n\PYZus{}channels}\PY{p}{)}\PY{p}{:}
                    \PY{n}{ch\PYZus{}max} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{max}\PY{p}{(}\PY{n}{img}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{p}{:}\PY{p}{,}\PY{n}{ch}\PY{p}{]}\PY{p}{)}
                    \PY{n}{ch\PYZus{}min} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{min}\PY{p}{(}\PY{n}{img}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{p}{:}\PY{p}{,}\PY{n}{ch}\PY{p}{]}\PY{p}{)}
                    \PY{n}{img}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{p}{:}\PY{p}{,}\PY{n}{ch}\PY{p}{]} \PY{o}{=} \PY{p}{(}\PY{n}{img}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{p}{:}\PY{p}{,}\PY{n}{ch}\PY{p}{]} \PY{o}{\PYZhy{}} \PY{n}{ch\PYZus{}min}\PY{p}{)}\PY{o}{/}\PY{p}{(}\PY{n}{ch\PYZus{}max}\PY{o}{\PYZhy{}}\PY{n}{ch\PYZus{}min}\PY{p}{)}        
                \PY{n}{norm\PYZus{}data\PYZus{}set}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{img}\PY{p}{)}
            \PY{k}{return} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{norm\PYZus{}data\PYZus{}set}\PY{p}{)}
        
        \PY{k}{def} \PY{n+nf}{RGB\PYZus{}2\PYZus{}gray\PYZus{}dataset}\PY{p}{(}\PY{n}{data\PYZus{}set}\PY{p}{)}\PY{p}{:}
            \PY{n}{n\PYZus{}samples}  \PY{o}{=} \PY{n}{data\PYZus{}set}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
            \PY{n}{grayScale\PYZus{}data\PYZus{}set} \PY{o}{=} \PY{p}{[}\PY{p}{]}
            \PY{k}{for} \PY{n}{s} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{n\PYZus{}samples}\PY{p}{)}\PY{p}{:}
                \PY{n}{img} \PY{o}{=} \PY{n}{cv2}\PY{o}{.}\PY{n}{cvtColor}\PY{p}{(}\PY{n}{data\PYZus{}set}\PY{p}{[}\PY{n}{s}\PY{p}{]}\PY{p}{,} \PY{n}{cv2}\PY{o}{.}\PY{n}{COLOR\PYZus{}RGB2GRAY}\PY{p}{)}
                \PY{n}{grayScale\PYZus{}data\PYZus{}set}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{img}\PY{p}{)}
        
            \PY{n}{grayScale\PYZus{}data\PYZus{}set} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{expand\PYZus{}dims}\PY{p}{(}\PY{n}{grayScale\PYZus{}data\PYZus{}set}\PY{p}{,} \PY{n}{axis} \PY{o}{=} \PY{l+m+mi}{3}\PY{p}{)}    
            \PY{k}{return} \PY{n}{grayScale\PYZus{}data\PYZus{}set}    
\end{Verbatim}


    \hypertarget{pre-process-the-training-validation-and-test-data}{%
\section{Pre-process the training, validation and test
data}\label{pre-process-the-training-validation-and-test-data}}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}9}]:} \PY{k}{if} \PY{n}{PREPROCESSING}\PY{p}{:}
            \PY{k}{if} \PY{n}{NORM\PYZus{}GRAY}\PY{p}{:}
                \PY{n}{X\PYZus{}train} \PY{o}{=} \PY{n}{RGB\PYZus{}2\PYZus{}gray\PYZus{}dataset}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{)}
                \PY{n}{X\PYZus{}valid} \PY{o}{=} \PY{n}{RGB\PYZus{}2\PYZus{}gray\PYZus{}dataset}\PY{p}{(}\PY{n}{X\PYZus{}valid}\PY{p}{)}
                \PY{n}{X\PYZus{}test}  \PY{o}{=} \PY{n}{RGB\PYZus{}2\PYZus{}gray\PYZus{}dataset}\PY{p}{(}\PY{n}{X\PYZus{}test}\PY{p}{)}
            
            \PY{n}{X\PYZus{}train} \PY{o}{=} \PY{n}{normalize\PYZus{}dataset}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{)}
            \PY{n}{X\PYZus{}valid} \PY{o}{=} \PY{n}{normalize\PYZus{}dataset}\PY{p}{(}\PY{n}{X\PYZus{}valid}\PY{p}{)}
            \PY{n}{X\PYZus{}test}  \PY{o}{=} \PY{n}{normalize\PYZus{}dataset}\PY{p}{(}\PY{n}{X\PYZus{}test}\PY{p}{)}
            \PY{n+nb}{print}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{o}{.}\PY{n}{shape}\PY{p}{)}
\end{Verbatim}
...
\subsubsection{Model Architecture}\label{model-architecture}}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}10}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Define your architecture here.}
         \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Feel free to use as many code cells as needed.}
         \PY{k+kn}{import} \PY{n+nn}{tensorflow} \PY{k}{as} \PY{n+nn}{tf}
         ...
         \PY{k}{def} \PY{n+nf}{maxpool2d}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{n}{k}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{)}\PY{p}{:}
             \PY{k}{return} \PY{n}{tf}\PY{o}{.}\PY{n}{nn}\PY{o}{.}\PY{n}{max\PYZus{}pool}\PY{p}{(}
                 \PY{n}{x}\PY{p}{,}
                 \PY{n}{ksize}\PY{o}{=}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{k}\PY{p}{,} \PY{n}{k}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,}
                 \PY{n}{strides}\PY{o}{=}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{k}\PY{p}{,} \PY{n}{k}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,}
                 \PY{n}{padding}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{SAME}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         
         \PY{k}{def} \PY{n+nf}{activation}\PY{p}{(}\PY{n}{x}\PY{p}{)}\PY{p}{:}
             \PY{k}{return} \PY{n}{tf}\PY{o}{.}\PY{n}{nn}\PY{o}{.}\PY{n}{dropout}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{nn}\PY{o}{.}\PY{n}{relu}\PY{p}{(}\PY{n}{x}\PY{p}{)}\PY{p}{,} \PY{n}{keep\PYZus{}prob}\PY{p}{)}
         ...
         \PY{k}{def} \PY{n+nf}{LeNet}\PY{p}{(}\PY{n}{x}\PY{p}{)}\PY{p}{:}    
             ...
             \PY{c+c1}{\PYZsh{} TODO: Layer 1: Convolutional. Input = 32x32. Output = 28x28x6.}
             \PY{c+c1}{\PYZsh{} Weights = 5X5X3X6 = 450}
             \PY{c+c1}{\PYZsh{} Biases = 6}
             \PY{k}{if} \PY{n}{NORM\PYZus{}GRAY}\PY{p}{:}
                 \PY{n}{n\PYZus{}channels} \PY{o}{=} \PY{l+m+mi}{1}
             \PY{k}{else}\PY{p}{:}
                 \PY{n}{n\PYZus{}channels} \PY{o}{=} \PY{l+m+mi}{3}
                 
             \PY{n}{filter\PYZus{}H}\PY{p}{,} \PY{n}{filter\PYZus{}W}\PY{p}{,} \PY{n}{inp\PYZus{}channels}\PY{p}{,} \PY{n}{out\PYZus{}channels} \PY{o}{=} \PY{p}{[}\PY{l+m+mi}{5}\PY{p}{,} \PY{l+m+mi}{5}\PY{p}{,} \PY{n}{n\PYZus{}channels}\PY{p}{,} \PY{l+m+mi}{6}\PY{p}{]}
             \PY{n}{wc1} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{Variable}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{truncated\PYZus{}normal}\PY{p}{(}\PY{p}{[}\PY{n}{filter\PYZus{}H}\PY{p}{,} \PY{n}{filter\PYZus{}W}\PY{p}{,} \PY{n}{inp\PYZus{}channels}\PY{p}{,} \PY{n}{out\PYZus{}channels}\PY{p}{]}\PY{p}{,} \PY{n}{mu}\PY{p}{,} \PY{n}{sigma}\PY{p}{)}\PY{p}{)}
             \PY{n}{bc1} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{Variable}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{n}{out\PYZus{}channels}\PY{p}{)}\PY{p}{)}    
             \PY{n}{conv1} \PY{o}{=} \PY{n}{conv2d}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{n}{wc1}\PY{p}{,} \PY{n}{bc1}\PY{p}{)}
             \PY{c+c1}{\PYZsh{} TODO: Activation.}
             \PY{n}{conv1} \PY{o}{=} \PY{n}{activation}\PY{p}{(}\PY{n}{conv1}\PY{p}{)}
             
         
             \PY{c+c1}{\PYZsh{} TODO: Pooling. Input = 28x28x6. Output = 14x14x6.}
             \PY{n}{maxp1} \PY{o}{=} \PY{n}{maxpool2d}\PY{p}{(}\PY{n}{conv1}\PY{p}{,} \PY{n}{k}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{)}
         
             \PY{c+c1}{\PYZsh{} TODO: Layer 2: Convolutional. Output = 10x10x16.}
             \PY{c+c1}{\PYZsh{} Weights = 5X5X6X16 = 2400}
             \PY{c+c1}{\PYZsh{} Biases = 16    }
             \PY{n}{filter\PYZus{}H}\PY{p}{,} \PY{n}{filter\PYZus{}W}\PY{p}{,} \PY{n}{inp\PYZus{}channels}\PY{p}{,} \PY{n}{out\PYZus{}channels} \PY{o}{=} \PY{p}{[}\PY{l+m+mi}{5}\PY{p}{,} \PY{l+m+mi}{5}\PY{p}{,} \PY{l+m+mi}{6}\PY{p}{,} \PY{l+m+mi}{16}\PY{p}{]}
             \PY{n}{wc2} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{Variable}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{truncated\PYZus{}normal}\PY{p}{(}\PY{p}{[}\PY{n}{filter\PYZus{}H}\PY{p}{,} \PY{n}{filter\PYZus{}W}\PY{p}{,} \PY{n}{inp\PYZus{}channels}\PY{p}{,} \PY{n}{out\PYZus{}channels}\PY{p}{]}\PY{p}{,} \PY{n}{mu}\PY{p}{,} \PY{n}{sigma}\PY{p}{)}\PY{p}{)}
             \PY{n}{bc2} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{Variable}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{n}{out\PYZus{}channels}\PY{p}{)}\PY{p}{)}    
             \PY{n}{conv2} \PY{o}{=} \PY{n}{conv2d}\PY{p}{(}\PY{n}{maxp1}\PY{p}{,} \PY{n}{wc2}\PY{p}{,} \PY{n}{bc2}\PY{p}{)}
             \PY{c+c1}{\PYZsh{} TODO: Activation.}
             \PY{n}{conv2} \PY{o}{=} \PY{n}{activation}\PY{p}{(}\PY{n}{conv2}\PY{p}{)}
             
             \PY{c+c1}{\PYZsh{} TODO: Pooling. Input = 10x10x16. Output = 5x5x16.}
             \PY{n}{maxp2} \PY{o}{=} \PY{n}{maxpool2d}\PY{p}{(}\PY{n}{conv2}\PY{p}{,} \PY{n}{k}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{)}
             \PY{c+c1}{\PYZsh{} TODO: Flatten. Input = 5x5x16. Output = 400.}
             \PY{n}{maxp2} \PY{o}{=} \PY{n}{flatten}\PY{p}{(}\PY{n}{maxp2}\PY{p}{)}
         
             \PY{c+c1}{\PYZsh{} TODO: Layer 3: Fully Connected. Input = 400. Output = 120.    }
             \PY{c+c1}{\PYZsh{} Weights = 400*120 = 48000}
             \PY{c+c1}{\PYZsh{} Biases = 120    }
             \PY{n}{fc3\PYZus{}inp} \PY{o}{=} \PY{l+m+mi}{400}
             \PY{n}{fc3\PYZus{}out} \PY{o}{=} \PY{l+m+mi}{120}
             \PY{n}{wfc3} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{Variable}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{truncated\PYZus{}normal}\PY{p}{(}\PY{p}{[}\PY{n}{fc3\PYZus{}inp}\PY{p}{,} \PY{n}{fc3\PYZus{}out}\PY{p}{]}\PY{p}{,} \PY{n}{mu}\PY{p}{,} \PY{n}{sigma}\PY{p}{)}\PY{p}{)}
             \PY{n}{bfc3} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{Variable}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{n}{fc3\PYZus{}out}\PY{p}{)}\PY{p}{)}    
             \PY{n}{fc3}  \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{add}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{matmul}\PY{p}{(}\PY{n}{maxp2}\PY{p}{,}\PY{n}{wfc3}\PY{p}{)}\PY{p}{,}\PY{n}{bfc3}\PY{p}{)}
             \PY{c+c1}{\PYZsh{} TODO: Activation.}
             \PY{n}{fc3} \PY{o}{=} \PY{n}{activation}\PY{p}{(}\PY{n}{fc3}\PY{p}{)}
         
             \PY{c+c1}{\PYZsh{} TODO: Layer 4: Fully Connected. Input = 120. Output = 84.}
             \PY{c+c1}{\PYZsh{} Weights = 120*84 = 10080}
             \PY{c+c1}{\PYZsh{} Biases = 84        }
             \PY{n}{fc4\PYZus{}inp} \PY{o}{=} \PY{l+m+mi}{120}
             \PY{k}{if} \PY{n}{MODIFIED\PYZus{}LENET}\PY{p}{:}
                 \PY{n}{fc4\PYZus{}out} \PY{o}{=} \PY{n}{N\PYZus{}CLASSES}
             \PY{k}{else}\PY{p}{:}
                 \PY{n}{fc4\PYZus{}out} \PY{o}{=} \PY{l+m+mi}{84}
                 
             \PY{n}{wfc4}    \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{Variable}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{truncated\PYZus{}normal}\PY{p}{(}\PY{p}{[}\PY{n}{fc4\PYZus{}inp}\PY{p}{,} \PY{n}{fc4\PYZus{}out}\PY{p}{]}\PY{p}{,} \PY{n}{mu}\PY{p}{,} \PY{n}{sigma}\PY{p}{)}\PY{p}{)}
             \PY{n}{bfc4}    \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{Variable}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{n}{fc4\PYZus{}out}\PY{p}{)}\PY{p}{)}    
             \PY{n}{fc4}     \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{add}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{matmul}\PY{p}{(}\PY{n}{fc3}\PY{p}{,}\PY{n}{wfc4}\PY{p}{)}\PY{p}{,}\PY{n}{bfc4}\PY{p}{)}
             
             \PY{k}{if} \PY{n}{MODIFIED\PYZus{}LENET}\PY{p}{:}
                 \PY{n}{logits} \PY{o}{=} \PY{n}{fc4}
                 \PY{k}{return} \PY{n}{logits}        
             \PY{k}{else}\PY{p}{:}
                 \PY{c+c1}{\PYZsh{} TODO: Activation.}
                 \PY{n}{fc4} \PY{o}{=} \PY{n}{activation}\PY{p}{(}\PY{n}{fc4}\PY{p}{)}
             
             
             \PY{c+c1}{\PYZsh{} TODO: Layer 5: Fully Connected. Input = 84. Output = N\PYZus{}CLASSES.}
             \PY{c+c1}{\PYZsh{} Weights = 84*43 = 3612}
             \PY{c+c1}{\PYZsh{} Biases = 43        }
             \PY{n}{fc5\PYZus{}inp} \PY{o}{=} \PY{l+m+mi}{84}
             \PY{n}{fc5\PYZus{}out} \PY{o}{=} \PY{n}{N\PYZus{}CLASSES}
             \PY{n}{wfc5}    \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{Variable}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{truncated\PYZus{}normal}\PY{p}{(}\PY{p}{[}\PY{n}{fc5\PYZus{}inp}\PY{p}{,} \PY{n}{fc5\PYZus{}out}\PY{p}{]}\PY{p}{,} \PY{n}{mu}\PY{p}{,} \PY{n}{sigma}\PY{p}{)}\PY{p}{)}
             \PY{n}{bfc5}    \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{Variable}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{n}{fc5\PYZus{}out}\PY{p}{)}\PY{p}{)}    
             \PY{n}{fc5}     \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{add}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{matmul}\PY{p}{(}\PY{n}{fc4}\PY{p}{,}\PY{n}{wfc5}\PY{p}{)}\PY{p}{,}\PY{n}{bfc5}\PY{p}{)}
                 
             \PY{n}{logits} \PY{o}{=} \PY{n}{fc5}    
...
\subsection{Train, Validate and Test the
...
\subsubsection{Training Pipeline}\label{training-pipeline}}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}11}]:} \PY{n}{EPOCHS} \PY{o}{=} \PY{l+m+mi}{20}
         \PY{n}{BATCH\PYZus{}SIZE} \PY{o}{=} \PY{l+m+mi}{128}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}12}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Train your model here.}
         ...
         \PY{n}{x} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{placeholder}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{float32}\PY{p}{,} \PY{p}{(}\PY{k+kc}{None}\PY{p}{,} \PY{l+m+mi}{32}\PY{p}{,} \PY{l+m+mi}{32}\PY{p}{,} \PY{n}{n\PYZus{}channels}\PY{p}{)}\PY{p}{)}
         \PY{n}{y} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{placeholder}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{int32}\PY{p}{,} \PY{p}{(}\PY{k+kc}{None}\PY{p}{)}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{} Regularization}
...
\end{Verbatim}
    ...
    \hypertarget{validate-the-model}{%
\subsection{Validate the model}\label{validate-the-model}}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}13}]:} \PY{n}{prediction} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{argmax}\PY{p}{(}\PY{n}{logits}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{)}
...
\end{Verbatim}
    ...
    correct\_prediction = tf.equal(tf.argmax(logits, 1),
tf.argmax(one\_hot\_y, 1)) accuracy\_operation =
{[}tf.reduce\_mean(tf.cast(correct\_prediction, tf.float32)),
correct\_prediction{]}

saver = tf.train.Saver()

def evaluate(X\_data, y\_data): label\_accuracy = np.zeros(N\_CLASSES)
num\_examples = len(X\_data) total\_accuracy = 0 sess =
tf.get\_default\_session() for offset in range(0, num\_examples,
BATCH\_SIZE): batch\_x, batch\_y =
X\_data{[}offset:offset+BATCH\_SIZE{]},
y\_data{[}offset:offset+BATCH\_SIZE{]} accuracy, correct\_prediction =
sess.run(accuracy\_operation, feed\_dict=\{x: batch\_x, y: batch\_y,
keep\_prob: 1\}) for lbl in range(N\_CLASSES): label\_accuracy{[}lbl{]}
+= np.count\_nonzero(lbl == batch\_y{[}np.array(correct\_prediction){]})
total\_accuracy += (accuracy * len(batch\_x)) return total\_accuracy /
num\_examples, label\_accuracy

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}14}]:} \PY{k+kn}{from} \PY{n+nn}{sklearn}\PY{n+nn}{.}\PY{n+nn}{utils} \PY{k}{import} \PY{n}{shuffle}
         
         \PY{k}{if} \PY{n}{TRAIN\PYZus{}MODEL}\PY{p}{:}
             \PY{k}{with} \PY{n}{tf}\PY{o}{.}\PY{n}{Session}\PY{p}{(}\PY{p}{)} \PY{k}{as} \PY{n}{sess}\PY{p}{:}
                 ...
                 \PY{n}{Dropout\PYZus{}prob} \PY{o}{=} \PY{l+m+mf}{0.65}
                 \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{EPOCHS}\PY{p}{)}\PY{p}{:}
                     ...
                     \PY{k}{for} \PY{n}{offset} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,} \PY{n}{num\PYZus{}examples}\PY{p}{,} \PY{n}{BATCH\PYZus{}SIZE}\PY{p}{)}\PY{p}{:}
                         ...
                         \PY{n}{sess}\PY{o}{.}\PY{n}{run}\PY{p}{(}\PY{n}{training\PYZus{}operation}\PY{p}{,} \PY{n}{feed\PYZus{}dict}\PY{o}{=}\PY{p}{\PYZob{}}\PY{n}{x}\PY{p}{:} \PY{n}{batch\PYZus{}x}\PY{p}{,} \PY{n}{y}\PY{p}{:} \PY{n}{batch\PYZus{}y}\PY{p}{,} \PY{n}{keep\PYZus{}prob}\PY{p}{:} \PY{n}{Dropout\PYZus{}prob}\PY{p}{\PYZcb{}}\PY{p}{)}
         
                     \PY{n}{training\PYZus{}accuracy} \PY{o}{=} \PY{n}{evaluate}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{:}\PY{n}{BATCH\PYZus{}SIZE}\PY{p}{]}\PY{p}{,} \PY{n}{y\PYZus{}train}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{:}\PY{n}{BATCH\PYZus{}SIZE}\PY{p}{]}\PY{p}{)}
                     ...
                     \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Training Batch Accuracy = }\PY{l+s+si}{\PYZob{}:.3f\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{training\PYZus{}accuracy}\PY{p}{)}\PY{p}{)}
                     \PY{n+nb}{print}\PY{p}{(}\PY{p}{)}
                 ...
                 \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Final Training Accuracy = }\PY{l+s+si}{\PYZob{}:.3f\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{training\PYZus{}accuracy}\PY{p}{)}\PY{p}{)}
                 \PY{n+nb}{print}\PY{p}{(}\PY{p}{)}        
                 \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Drop out prob = }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{Dropout\PYZus{}prob}\PY{p}{)}\PY{p}{)}
...
Model saved
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}15}]:} \PY{k}{if} \PY{n}{EVALUATE}\PY{p}{:}
             \PY{n}{saver} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{train}\PY{o}{.}\PY{n}{Saver}\PY{p}{(}\PY{p}{)}
             \PY{k}{with} \PY{n}{tf}\PY{o}{.}\PY{n}{Session}\PY{p}{(}\PY{p}{)} \PY{k}{as} \PY{n}{sess}\PY{p}{:}
                 \PY{n}{saver}\PY{o}{.}\PY{n}{restore}\PY{p}{(}\PY{n}{sess}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./lenet}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
                 \PY{n}{X\PYZus{}data} \PY{o}{=} \PY{n}{X\PYZus{}test}
                 \PY{n}{y\PYZus{}data} \PY{o}{=} \PY{n}{y\PYZus{}test}
                 \PY{n}{dataset\PYZus{}accuracy} \PY{o}{=} \PY{n}{evaluate}\PY{p}{(}\PY{n}{X\PYZus{}data}\PY{p}{,} \PY{n}{y\PYZus{}data}\PY{p}{)}
                 \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{data set accuracy = }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{dataset\PYZus{}accuracy}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}16}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Load the images and plot them here.}
         \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Feel free to use as many code cells as needed.}
         \PY{k+kn}{import} \PY{n+nn}{os}\PY{o}{,} \PY{n+nn}{os}\PY{n+nn}{.}\PY{n+nn}{path}
         \PY{k+kn}{import} \PY{n+nn}{matplotlib}\PY{n+nn}{.}\PY{n+nn}{image} \PY{k}{as} \PY{n+nn}{mpimage}
         \PY{k+kn}{import} \PY{n+nn}{matplotlib}\PY{n+nn}{.}\PY{n+nn}{pyplot} \PY{k}{as} \PY{n+nn}{plt}
         \PY{k+kn}{import} \PY{n+nn}{cv2}
         
         \PY{n}{X\PYZus{}test\PYZus{}web} \PY{o}{=} \PY{p}{[}\PY{p}{]}
         \PY{n}{y\PYZus{}test\PYZus{}web} \PY{o}{=} \PY{p}{[}\PY{p}{]}
         \PY{n}{path} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{./traffic\PYZhy{}signs\PYZhy{}data/webimages/}\PY{l+s+s2}{\PYZdq{}}
         \PY{n}{valid\PYZus{}images} \PY{o}{=} \PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{.jpg}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{.gif}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{.png}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{.tga}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}
         \PY{k}{for} \PY{n}{f} \PY{o+ow}{in} \PY{n}{os}\PY{o}{.}\PY{n}{listdir}\PY{p}{(}\PY{n}{path}\PY{p}{)}\PY{p}{:}
             \PY{n}{ext} \PY{o}{=} \PY{n}{os}\PY{o}{.}\PY{n}{path}\PY{o}{.}\PY{n}{splitext}\PY{p}{(}\PY{n}{f}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}
             \PY{k}{if} \PY{n}{ext}\PY{o}{.}\PY{n}{lower}\PY{p}{(}\PY{p}{)} \PY{o+ow}{not} \PY{o+ow}{in} \PY{n}{valid\PYZus{}images}\PY{p}{:}
                 \PY{k}{continue}
             \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{read image = }\PY{l+s+s1}{\PYZsq{}} \PY{o}{+} \PY{n}{f}\PY{p}{)}
             \PY{n}{image} \PY{o}{=} \PY{n}{mpimage}\PY{o}{.}\PY{n}{imread}\PY{p}{(}\PY{n}{path}\PY{o}{+}\PY{n}{f}\PY{p}{)}
             \PY{n}{dim} \PY{o}{=} \PY{p}{(}\PY{l+m+mi}{32}\PY{p}{,} \PY{l+m+mi}{32}\PY{p}{)}
             \PY{n}{image} \PY{o}{=} \PY{n}{cv2}\PY{o}{.}\PY{n}{resize}\PY{p}{(}\PY{n}{image}\PY{p}{,} \PY{n}{dim}\PY{p}{,} \PY{n}{interpolation} \PY{o}{=} \PY{n}{cv2}\PY{o}{.}\PY{n}{INTER\PYZus{}AREA}\PY{p}{)}
             \PY{n+nb}{print}\PY{p}{(}\PY{n}{image}\PY{o}{.}\PY{n}{shape}\PY{p}{)}
             \PY{n}{X\PYZus{}test\PYZus{}web}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{image}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{image}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{X\PYZus{}test\PYZus{}web}\PY{p}{)}\PY{o}{.}\PY{n}{shape}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}18}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Run the predictions here and use the model to output the prediction for each image.}
         ...
         \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Feel free to use as many code cells as needed.}
         \PY{n}{X\PYZus{}test\PYZus{}web} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{X\PYZus{}test\PYZus{}web}\PY{p}{)}
         \PY{n}{X\PYZus{}test\PYZus{}web} \PY{o}{=} \PY{n}{RGB\PYZus{}2\PYZus{}gray\PYZus{}dataset}\PY{p}{(}\PY{n}{X\PYZus{}test\PYZus{}web}\PY{p}{)}
         \PY{n}{X\PYZus{}test\PYZus{}web} \PY{o}{=} \PY{n}{normalize\PYZus{}dataset}\PY{p}{(}\PY{n}{X\PYZus{}test\PYZus{}web}\PY{p}{)}
         \PY{n}{y\PYZus{}test\PYZus{}web} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{23}\PY{p}{,} \PY{l+m+mi}{23}\PY{p}{,} \PY{l+m+mi}{28}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{9}\PY{p}{,} \PY{l+m+mi}{28}\PY{p}{,} \PY{l+m+mi}{23}\PY{p}{,} \PY{l+m+mi}{28}\PY{p}{]}\PY{p}{)}
\end{Verbatim}
...
\subsubsection{Analyze Performance}\label{analyze-performance}}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}19}]:} \PY{n}{saver} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{train}\PY{o}{.}\PY{n}{Saver}\PY{p}{(}\PY{p}{)}
         \PY{k}{with} \PY{n}{tf}\PY{o}{.}\PY{n}{Session}\PY{p}{(}\PY{p}{)} \PY{k}{as} \PY{n}{sess}\PY{p}{:}
             \PY{n}{saver}\PY{o}{.}\PY{n}{restore}\PY{p}{(}\PY{n}{sess}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./lenet}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
             \PY{n}{X\PYZus{}data} \PY{o}{=} \PY{n}{X\PYZus{}test\PYZus{}web}
             \PY{n}{y\PYZus{}data} \PY{o}{=} \PY{n}{y\PYZus{}test\PYZus{}web}
             \PY{n}{dataset\PYZus{}accuracy} \PY{o}{=} \PY{n}{evaluate}\PY{p}{(}\PY{n}{X\PYZus{}data}\PY{p}{,} \PY{n}{y\PYZus{}data}\PY{p}{)}
             \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{data set accuracy = }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{dataset\PYZus{}accuracy}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}20}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Print out the top five softmax probabilities for the predictions on the German traffic sign images found on the web. }
         \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Feel free to use as many code cells as needed.}
         \PY{n}{saver} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{train}\PY{o}{.}\PY{n}{Saver}\PY{p}{(}\PY{p}{)}
         \PY{n}{dataset\PYZus{}prediction} \PY{o}{=} \PY{p}{[}\PY{p}{]}
         \PY{n}{top\PYZus{}k\PYZus{}predictions} \PY{o}{=} \PY{p}{[}\PY{p}{]}
         \PY{k}{with} \PY{n}{tf}\PY{o}{.}\PY{n}{Session}\PY{p}{(}\PY{p}{)} \PY{k}{as} \PY{n}{sess}\PY{p}{:}
             \PY{n}{saver}\PY{o}{.}\PY{n}{restore}\PY{p}{(}\PY{n}{sess}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./lenet}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
             \PY{n}{X\PYZus{}data} \PY{o}{=} \PY{n}{X\PYZus{}test\PYZus{}web}
             \PY{n}{k} \PY{o}{=} \PY{l+m+mi}{5}
             \PY{n}{top\PYZus{}k\PYZus{}values}\PY{p}{,} \PY{n}{top\PYZus{}k\PYZus{}ind} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{nn}\PY{o}{.}\PY{n}{top\PYZus{}k}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{nn}\PY{o}{.}\PY{n}{softmax}\PY{p}{(}\PY{n}{sess}\PY{o}{.}\PY{n}{run}\PY{p}{(}\PY{n}{logits}\PY{p}{,} \PY{n}{feed\PYZus{}dict}\PY{o}{=}\PY{p}{\PYZob{}}\PY{n}{x}\PY{p}{:} \PY{n}{X\PYZus{}data}\PY{p}{,} \PY{n}{keep\PYZus{}prob}\PY{p}{:} \PY{l+m+mi}{1}\PY{p}{\PYZcb{}}\PY{p}{)}\PY{p}{)}\PY{p}{,} \PY{n}{k}\PY{p}{)}
             \PY{n}{dataset\PYZus{}prediction}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{top\PYZus{}k\PYZus{}ind}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}
             \PY{n}{top\PYZus{}k\PYZus{}predictions}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{top\PYZus{}k\PYZus{}ind}\PY{p}{)}
             \PY{n+nb}{print}\PY{p}{(}\PY{n}{sess}\PY{o}{.}\PY{n}{run}\PY{p}{(}\PY{n}{top\PYZus{}k\PYZus{}predictions}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
